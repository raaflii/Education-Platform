    ...
    <div class="min-h-screen flex">
        ...
        <div class="w-64 bg-gray-800 text-white">
            ...
            <nav class="mt-4">
                ...
                <a href="{{ route('admin.courses.index') }}" class="block px-4 py-2 hover:bg-gray-700">
                    Course
                </a>
                <a href="{{ route('admin.course-categories.index') }}" class="block px-4 py-2 hover:bg-gray-700">
                    Kategori Course
                </a>

...
@section('content')
    <div class="mb-6">
        <a href="{{ route('admin.categories.create') }}"
            class="bg-blue-600 dark:bg-blue-700 text-white px-4 py-2 rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 inline-flex items-center transition-colors dark-transition">
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <a href="{{ route('admin.categories.create') }}" 
                                       class="mt-4 bg-blue-600 dark:bg-blue-700 text-white px-4 py-2 rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 inline-flex items-center text-sm transition-colors">
